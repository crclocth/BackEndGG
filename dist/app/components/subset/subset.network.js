...
const subset_controller_1 = __importDefault(require("./subset.controller"));
const router = express_1.default.Router();
router.get("/all", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield subset_controller_1.default.getSubset();
...
router.get("/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield subset_controller_1.default.getSubsetById(id);
            response_module_1.default.success(req, res, result);
        }
        catch (error) {
            console.log(error);
...
router.post("/add", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const body = req.body;
        try {
            const result = yield subset_controller_1.default.addSubset(body);
...
router.delete("/delete", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const ver = yield subset_controller_1.default.deleteSubset(req.body._id);
            if (ver != null) {
...
router.patch("/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const modPaciente = yield subset_controller_1.default.patchSubset(id, req.body);
